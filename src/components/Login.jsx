    ...
    return (
        ...
        md:w-[30%] md:h-[70%] md:left-1/2 md:top-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2">
            ...
            <div className="flex flex-col gap-4 p-6">
                ...
                <input type="text" name="username" id="username" className="p-2 rounded bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"/>

                <label htmlFor="password" className="text-sm font-light">
                    Password
                </label>
                <input type="password" name="password" id="password" className="p-2 rounded bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                ...
                <div className="text-sm text-center hover:underline text-gray-100">Don't have account? Register here!</div>
            </div>
        </div>
    );
};
